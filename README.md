...
---
 ...
 - 从 OpenWrt 的 [SDK][S] 编译
   ...
   # 添加 feeds
   git clone https://github.com/zppan/openwrt-feeds.git package/feeds
   # 获取 shadowsocks-libev Makefile
   git clone https://github.com/zppan/openwrt-shadowsocksr.git package/feeds/shadowsocksr-libev
